...
<body>
    ...
    <section id="frase">
        ...
        <p>OFRECIENDO ASISTENCIA EN CARRETERA. CONÉCTATE CON MÁS CLIENTES, GESTIONA TUS SERVICIOS FÁCILMENTE Y CRECE CON NOSOTROS.</p>
    </section>
        ...
        <form:form action="/registro/nuevo?tipoDeUsuario=prestador" method="POST" modelAttribute="baseUser">
            ...
            <div>
                ...
                <div style="display: flex; align-items: center;">
                    <span>+56 9</span>
                    <form:input path="numero" maxlength="8" placeholder="12345678" pattern="[0-9]{8}" title="Debe ingresar solo 8 dígitos"/>
                </div>
            </div>
            ...
            <div>
                ...
                <form:select path="licencia">
                    ...
                    <option value="A2">Clase A2 - Taxis, ambulancias, transporte de hasta 17 pasajeros</option>
                    <option value="A3">Clase A3 - Transporte público sin límite de asientos</option>
                    <option value="A4">Clase A4 - Transporte de carga superior a 3,500 kg</option>
                    <option value="A5">Clase A5 - Vehículos de carga pesada superior a 3,500 kg</option>
                    ...
                    <option value="F">Clase F - Vehículos de fuerzas armadas y policiales</option>
                </form:select>
            </div>
